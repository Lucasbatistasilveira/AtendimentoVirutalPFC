	...
	public static class AppConstatns
    {
		...
		public static class StateMessages 
		{
			...
			public static class StateMoodleInconsistency 
			{
				...
				public static final String COURSES_NOT_FOUND = "Não foi encontrada nenhuma turma associada à sua matrícula. Favor entrar em contato com o colegiado do seu curso.";
